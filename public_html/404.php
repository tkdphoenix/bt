...
$randomFacts = array(
	...
	"101 Dalmatians, Peter Pan, Sleeping Beauty, Brave, Tangled, Lady and the Tramp, and Mulan are the only Disney cartoons where both parents are present and don't die throughout the movie.",
	...
	"Crocodiles and alligators are surprisingly fast on land. Although they are rapid, they are not agile.  So, if being chased by one, run in a zigzag line to lose the alligator.",
	...
	"The first automobile race ever seen in the United States was held in Chicago in 1895.The track ran from Chicago to Evanston, Illinois. The winner was J. Frank Duryea, whose average speed was 7-1/2 miles per hour.",
	...
	"Valentine Tapley from Pike County, Missouri  grew chin whiskers attaining a length of twelve feet six inches from 1860 until his death in 1910, as a protest to Abraham Lincoln's election to the presidency.",
	...
	"Mary Queen of Scots used a croquet mallet made from a Narwhall's horn.",
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<img class="img-responsive mainImg" src="/img/couch.jpeg" alt="couch.">
				<p class="text-center">I have no idea where that file is, sorry. Perhaps it is with that sock that you lost. (It's under the couch)</p>

				<p class="text-center">By the way, here is your random fact for the day:</p>
				<p class="text-center randomFact"><?=$randomFacts[$randomNum];?></p>
				<p class="text-center">Now you can't say you didn't learn anything today.</p>
				<p class="text-center"><a href="index.php">Go to the home page</a></p>
			</div>
		</div>
	</div>
</body>
